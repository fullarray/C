...
int score=o, spd, q, t, a=o, i, j, l[6] = {300,90,315,105,301,91},p,turn,m,n;
char play='y';
...
void main(void){
	...
	do{
		...
		do{
			...
			printf("Middle level ......1");
			printf("Advanced level ......1");
			printf("Experts level ......1");
			printf("Professional level ......1");
			...
			if(y=='5'){
				spd=50;
				settextstyle(2,0,6);
				outtext(2,150,"Professional Level");
				break;
			}	
		}while(1);
